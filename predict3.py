...
#            a = xvalidation(newpos, newneg, newneu, 10)
            a = xvalidation(newpos, newneg, 10)
            if 'acc' not in vars():
                acc = a
            else:
                acc = acc + a
...
fhc = codecs.open("../hc_train_full.txt", 'r', "utf-8")
fdt = codecs.open("../dt_train_full.txt", 'r', "utf-8")
...
#neucut = int(len(neu))
negcut = int(len(neg))
#print(poscut, neucut, negcut, poscut+neucut+negcut)
print(poscut, negcut, poscut+negcut)
...
train_data1 = pos[:poscut] + neg[:negcut] 
train_labels1 = ['pos'] * poscut + ['neg'] * negcut
...
train_data2 = pos[:poscut] + neg[:negcut] 
train_labels2 = ['pos'] * poscut + ['neg'] * negcut 
